...
export function Footer() {
  ...
  return (
    <footer
      className="w-full bg-surface-container-low border-t border-outline-border pt-10 pb-6 font-sans"
      dir="rtl"
    >
      <div className="max-w-7xl mx-auto px-4 lg:px-12 flex flex-col items-center gap-6">
        ...
        <Link
          ...
          className="inline-flex items-center gap-3 bg-surface-white px-6 py-3 rounded-xl border border-primary-light/30 shadow-level-2 hover:shadow-level-3 transition-all duration-200 hover:-translate-y-0.5 group"
        >
          {/* WhatsApp Icon */}
          ...
          <span className="font-semibold text-[15px] text-primary">01115956226</span>
          <span className="text-[14px] text-on-surface-variant">:تواصل معنا</span>
        </Link>

        {/* Divider */}
        <div className="w-3/4 h-px bg-primary-light/20" />
        ...
        {/* Copyright */}
        <p className="text-[12px] text-on-surface-variant tracking-wider">
